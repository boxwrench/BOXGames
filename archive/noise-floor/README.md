# NOISE FLOOR (archived)

> **Archived.** This was BOXGames' first direction: a Go + Vulkan demo on the
> [Kaiju Engine](https://github.com/KaijuEngine/kaiju) starring BX-77 "Boxwrench" from
> [boxwrench.dev](https://www.boxwrench.dev/). It stopped at an early scaffold and is kept here for reference only.
> Everything below still works from inside this folder (`cd archive/noise-floor` first).
